...
<head>
    ...
    <title>Smart HRMS | 403 Forbidden</title>
    <style>
        :root {
        ...
        * {
        ...
        .card {
            ...
            box-shadow:
                0 20px 45px -28px rgba(31, 94, 52, 0.42),
        ...
        .btn-primary {
            background: var(--brand-base);
            color: #f8fff9;
            border-color: rgba(31, 94, 52, 0.42);
        }
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .card {
                ...
                box-shadow:
                    0 22px 42px -26px rgba(0, 0, 0, 0.62),
                    0 0 0 1px rgba(74, 124, 60, 0.22);
            }

            .badge {
                background: rgba(15, 23, 42, 0.65);
                border-color: rgba(145, 195, 131, 0.35);
                color: #d9f0d2;
            }
...
<body>
    @php
        ...
        $dashboardUrl = $user?->role === 'hr-personnel'
            ...
            : route('dashboard');
        $primaryUrl = $user ? $dashboardUrl : route('login');
    ...
    <main class="card" role="main">
        ...
        <p class="brand">"An algorithmic approach to process automation and support decision making."</p>
</body>
</html>
