...
<head>
    ...
    <title>Smart HRMS | 500 Server Error</title>
    <style>
        :root {
...
<body>
    ...
    <main class="card" role="main">
        ...
        <p>{{ app()->hasDebugModeEnabled() ? ($exception->getMessage() ?: 'Unexpected server error.') : 'An unexpected error occurred. Please try again in a moment.' }}</p>
        <div class="actions">
